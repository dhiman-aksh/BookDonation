...
app.post('/uploadbook', function(req, res){
    ...
    var sql = "insert into bookupload values (null, '"+ req.body.firstname +"', '"+ req.body.lastname +"', '"+ req.body.address +"', '"+ req.body.city +"', '"+ req.body.state +"', '"+ req.body.zip +"', '"+ req.body.email +"', '"+ req.body.contact +"', '"+ req.body.bookname +"', '"+ req.body.genre +"', '"+ req.body.year +"', '"+ req.body.description +"')";
    db.query(sql, function(err){
...
app.post('/uploadrequest', function(req, res){
    ...
    var sql = "insert into requpload values (null, '"+ req.body.firstname +"', '"+ req.body.lastname +"', '"+ req.body.address +"', '"+ req.body.city +"', '"+ req.body.state +"', '"+ req.body.zip +"', '"+ req.body.email +"', '"+ req.body.contact +"', '"+ req.body.bookname +"', '"+ req.body.genre +"', '"+ req.body.year +"', '"+ req.body.description +"')";
    db.query(sql, function(err){
